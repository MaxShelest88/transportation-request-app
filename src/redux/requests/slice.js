  ...
  items: [
    {
      ...
      id: 0,
      path: {
        startPoint: { name: 'Москва', value: 'Moscow', position: [55.75396, 37.620393] },
        finishPoint: { name: 'Рязань', value: 'Ryazan', position: [54.60954, 39.71259] },
      },
    },
    {
      title: 'Заявка 2',
      id: 1,
      path: {
        startPoint: { name: 'Тверь', value: 'Tver', position: [56.85872, 35.9176] },
        finishPoint: { name: 'Тула', value: 'Tula', position: [54.1961, 37.6182] },
      },
    },
    {
      title: 'Заявка 3',
